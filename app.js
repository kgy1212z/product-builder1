...
const destinationsByNeighborhood = {
    ...
    "용산구": [
        ...
        },
        {
            ...
            hours: "10:00 - 18:00 (주말/공휴일 19:00)"
        },
        {
            name: "이태원",
    ...
    "성동구": [
        {
            ...
            website: "https://parks.seoul.go.kr/seoulforest",
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const modalDetailsContainer = document.getElementById('modal-details-container'); // New
    ...
    const openModal = (placeName) => {
        ...
        if (!destination) return; // Exit if not found
